...
### 7. Make another DataBase name -> posts
### 8. Create a Table named -> nposts
### 9. Make 5 columns -> name, title, summary, body, dater
### . Go to localhost/(foldername)/index.html and use it ! :D
